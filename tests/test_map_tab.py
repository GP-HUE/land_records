...
def main():
    ...
    checks = [
        ...
        ("tile source: OSM mirror subdomains abc", "subdomains: 'abc'"),
        ("tile source: OSM mirror in dropdown", 'value="osm_de"'),
        ("tile source: OSM mirror in auto-fallback chain", "['osm', 'osm_de', 'esri', 'carto', 'topo']"),
        ("tile source: OSM mirror label", "osm_de:'OSM (mirror)'"),
